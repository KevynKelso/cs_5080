...
A 4 x 4 grid structure \ref{fig:intersection_grid} of traffic lights will be used as it is also widely used by other papers \cite{Almeida2022MultiagentRL}.
...
The greedy algorithm selects the mode to allow the maximum queue length direction through.
...
Experience replay and other DQN methods showed to significantly increase the chances of convergeance and improve performance by an order of magnitude \cite{Mnih2015}.
